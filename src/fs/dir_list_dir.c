 ...
 void *arg)
{
    ...
    void (*ptr)(os_slcstr_t *path, os_slcstr_t *name, bool is_dir, void *arg) =
        (void (*)(os_slcstr_t *path, os_slcstr_t *name, bool is_dir, void *arg))
            (uintptr_t)callback;
    ...
    return ((void)(
        ...
        (res = __os_dir_list_dir((os_slcstr_t *)path, ptr, arg))
    ), res);
}
