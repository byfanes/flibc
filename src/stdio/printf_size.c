...
(fc_arg_t arg, bool isHex, uint32_t* out)
{
    ...
    *out = 0;
    switch (arg.type) {
        ...
        case _type_char: { *out = 1; return fce_success; }
        ...
        case _type_u64:
            { *out = len_of_num(arg.data._u64, isHex); } return fce_success;
        case _type_void_ptr:
            { *out = len_of_num((uint64_t)arg.data._vptr, true); } return fce_success;
    }
